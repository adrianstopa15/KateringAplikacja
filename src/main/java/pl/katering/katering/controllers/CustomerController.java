...
public class CustomerController {
    ...
    public ResponseEntity<?> editCustomer(@RequestBody Customer customer, @RequestParam Integer id) {
        return ResponseEntity.ok(customerService.editCustomer(customer, id));
    }
